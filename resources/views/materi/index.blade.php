...
<body>
    ...
    <div id="id01" class="modal">
        <form class="modal-content" action="{{ url('/guru/kelas/' . $kelas->id . '/materi/' . $materi->id) }}"
            method="POST" id="edit">
            @csrf
            @method('patch')
            ...
            <div class="container">
                ...
                <input class="mtr" type="text" name="judul" value="{{ $materi->judul }}"
                    ...
                    <div>
                        <div>
                            ...
                            <div class="form-group">
                                <textarea name="isi" id="froala-editor">{{ $materi->isi }} 
                                </textarea>
                            </div>
                        </div>
                    </div>
    ...
    <div id="id3" class="modal">
        <form class="mdl-content" action="{{ url('/guru/kelas/' . $kelas->id . '/materi/' . $materi->id) }}"
            method="POST">
            @csrf
            @method('delete')
